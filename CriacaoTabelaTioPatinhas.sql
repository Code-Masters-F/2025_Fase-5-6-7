...
CREATE SEQUENCE SEQ_CRYPTO START WITH 1 INCREMENT BY 1 NOMAXVALUE;
CREATE SEQUENCE SEQ_CONTA START WITH 1 INCREMENT BY 1 NOMAXVALUE;
CREATE SEQUENCE SEQ_CARTEIRA START WITH 1 INCREMENT BY 1 NOMAXVALUE;
CREATE SEQUENCE SEQ_TRANSACAO_FIAT START WITH 1 INCREMENT BY 1 NOMAXVALUE;
CREATE SEQUENCE SEQ_TRANSACAO_CRYPTO START WITH 1 INCREMENT BY 1 NOMAXVALUE;
