        ...
        do {
            ...
            try {
                switch (opcao) {
                    ...
                    case "4" -> CriptomoedaService.cadastrarCriptomoeda(scanner);
                    case "5" -> CriptomoedaService.listarCriptomoedas();
                    case "6" -> CriptomoedaService.comprarCriptomoeda(scanner);
                    case "7" -> CriptomoedaService.venderCriptomoeda(scanner);
                    case "0" ->  {
