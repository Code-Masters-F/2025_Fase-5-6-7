        ...
        do {
            ...
            try {
                switch (opcao) {
                    ...
                    case "10": adicionarSaldo(scanner); break;
                    case "11": listarCriptoativos(); break;
                    case "12": comprarCrypto(scanner); break;
                    case "13": venderCrypto(scanner); break;
                    case "14": cadastrarCrypto(scanner); break;
