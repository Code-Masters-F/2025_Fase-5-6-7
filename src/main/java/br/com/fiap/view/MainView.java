...
public class MainView {
        ...
        do {
            ...
            try {
                switch (opcao) {
                    ...
                    case "9": enviarTransferenciaContaExternaParaInterna(scanner); break;
                    case "10": comprarCriptomoeda(scanner); break;
                    case "11": venderCriptomoeda(scanner); break;
                    case "12": consultarHistoricoTransacoes(scanner); break;
                    case "13": submenuCriptomoedas(scanner); break;
                    case "0":
    ...
    private static void exibirMenu() {
        ...
        System.out.println("8  - Enviar Transferência de Conta Interna para Conta Externa");
        System.out.println("9  - Enviar Transferência de Conta Externa para Conta Interna");
        System.out.println("10 - Comprar criptomoeda");
        System.out.println("11 - Vender criptomoeda");
        System.out.println("12 - Consultar histórico de transações");
        System.out.println("13 - Gerenciar Criptomoedas");
